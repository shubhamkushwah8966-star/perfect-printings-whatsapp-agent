...
async function replyToCustomer(to, text) {
  ...
  if (hasQuotedPrice && confirmsOrder) await sendAssetOnce(to, "payment-qr", () => sendImage(to, "payment-qr.jpeg", "50% advance payment QR. Payment ke baad screenshot share kar dijiye."));
